...
enum class TestCases(
    ...
    MBW_RAND_APP(R.string.app_perf_title, MBW_APP_PERF_VALUE),
...
fun TestCases.isRandFIO(): Boolean = this in listOf(TestCases.FIO_RAND_RD, TestCases.FIO_RAND_WR)
